...
export const workHistoryJP: History[] = [
  {
    ...
    points: [
      "フロントエンドWebアプリケーションのためにTypescriptとReact、REST APIのためにGoとGinを使用して、インドネシアの複数のマーケットプレイスに統合されたオンラインショップ管理システムの開発に貢献いたしました。システムの全機能の30％を開発いたしました。",
      "メインのREST APIのためにGoとGin、アドミンWebアプリケーションのためにRuby on Railsを使用して、ギターとウクレレのコードと歌詞カラオケのようにが流れる音楽学習アプリケーションの開発に貢献いたしました。プレイリスト、レポート、プレイの履歴、人気曲や好きな曲の主要機能を開発いたしました。",
      "メインのREST APIのためにGoとGin、メインのフロントエンドWebアプリケーションのためにTypescriptとReact、アドミンWebアプリケーションのためにRuby on Railsを使用して、ミュージシャンとコンテンツクリエイターのためのサウンド共有プラットフォームの開発に貢献いたしました。コレクションとレポートの主要機能を開発いたしました。",

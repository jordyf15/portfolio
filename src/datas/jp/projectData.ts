...
const projectsJP: Array<Project> = [
  {
    ...
    title: "スマートラーニングシステム",
    description:
      "スマートラーニングシステムは中学・高校の学生と先生の学習と教育活動を支援する機能あるWebベースの学習管理システムでございます。このプロジェクトの主な機能は授業、教材、課題、フォーラム、スコア、進捗状況、お知らせ、アジェンダでございます。このプロジェクトはビナヌサンタラ大学の学位論文のために作られました。",
